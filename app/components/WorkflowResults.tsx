...
export const WorkflowResults = ({ result }: WorkflowResultsProps) => {
    ...
    return (
        <div className="mt-8 border-t-2 border-gray-100 pt-8">
            ...
            ${isRunning ? "bg-gradient-to-r from-gray-50 to-gray-100 border-2 border-gray-300"
                    : result.success
            ...
            {result.confluencePages && result.confluencePages.length > 0 && (
                <div className="mb-8">
                    ...
                    <div className="grid gap-4">
                        {result.confluencePages.map((page: any, index: any) => (
                            <div key={index} className="bg-white p-5 rounded-xl border-2 border-gray-200
            ...
            {result.githubIssues && result.githubIssues.length > 0 && (
                <div>
                    ...
                    <div className="grid gap-4">
                        {result.githubIssues.map((issue: any, index: any) => (
                            <div
                                key={index}
                                className="bg-gradient-to-r from-purple-50 to-pink-50 p-5 rounded-xl
                            border-2 border-purple-200 hover:border-purple-400 hover:shadow-md transition-all duration-200">
                                <div className="font-bold text-lg text-gray-900">
                                    {issue.title}
                                </div>
                                <div className="flex items-center justify-between mt-3">
                                    ...
                                    {issue.issueUrl && (
                                        ...
                                        text-white rounded-lg font-medium hover:bg-purple-700 transition-colors">
                                            Issueを開く
